...
class DB_Functions {
    ...
    public function storeUser($name, $email, $password) {
        ...
        $stmt = $this->conn->prepare("INSERT INTO clients(unique_id, name, email, encrypted_password, salt, created_at) VALUES(?, ?, ?, ?, ?, NOW())");
    ...
    public function getResort($resortName) {

        $stmt = $this->conn->prepare("SELECT * FROM resorts WHERE  name = ?");

        $stmt->bind_param("s", $resortName);
